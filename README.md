...
Cada día, un workflow recopila las noticias más relevantes de esos cuatro temas, las deduplica, genera un resumen y las publica como un digest fechado. El sitio muestra el digest del día (`index.html`) y un histórico navegable por fecha (`archive.html`).
...
1. Genera el digest del día como JSON.
...
El sitio estático (sin build ni backend) lee esos JSON directamente para renderizar el digest actual y el archivo histórico.
...
```jsonc
{
  "daily_summary": "Resumen general del día",
  "topic_summaries": {
    "apple": "...",
    "ai_software": "...",
    "ai_general": "...",
